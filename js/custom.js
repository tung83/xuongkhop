...
jQuery(function($){
	...
	/* ----------------------------------------------------------- */
      ...
      $('#map_canvas').gmap().bind('init', function(ev, map) {
        $('#map_canvas').gmap('addMarker', {'position': '10.7655063,106.6302483', 'bounds': true});
        $('#map_canvas').gmap('option', 'zoom', 13);
        $('#map_canvas').gmap('title','E1');
      });*/
      var myLatLng = {lat: 10.7655063, lng: 106.6302483};
      ...
      var infowindow = new google.maps.InfoWindow({
        content: "<span>80/4 Luỹ Bán Bích - P.Tân Thới Hoà - Q.Tân Phú - HCM</span>"
      });
